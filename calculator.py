...
print(Style.BRIGHT + Fore.GREEN + "Автор - fanat skiLLa1" + Fore.RESET)
print()
print(Fore.LIGHTBLUE_EX + "Здравствуйте, вас приветствует \"умный калькулятор!\" (v 3.0)\n" + Fore.RESET)
print(Back.LIGHTRED_EX + "|======================================================|" + Back.RESET)
print(Back.LIGHTRED_EX + "|P.s: весь текст нужно писать с маленькой буквы!       |" + Back.RESET)
print(Back.LIGHTRED_EX + "|======================================================|" + Back.RESET)
...
if ans1 == "да":
    ...
    print(Back.LIGHTMAGENTA_EX + "|14) Пасхалка                      |" + Back.RESET)
    print("|15) Выход                         |")
    print("|----------------------------------|\n")
...
while ans2 != 15:
    if ans2 == 1:
        ...
        print()
        print("Вы выбрали пункт --> \"Пасхалка\"!\n")
        print("Введите число:", end=" ")
        n = int(input())
        print()
        for i in range(n):
...
print()
print(Back.GREEN + "Спасибо за использование данного калькулятора (●'◡'●)" + Back.RESET)
print(Back.GREEN + "Нажмите клавишу --> \"enter\" для завершения программы!" + Back.RESET)
